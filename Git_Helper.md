...
####2.Clone
在使用git前，首先你要有个git服务器，目前用的最多的免费git仓库是github。例如午安煎饼计划PHP组的Git地址是：https://github.com/wuanlife/Jianbing_PHP.git ，前端组的Git地址是：https://github.com/wuanlife/Jianbing_Web.git ，UI组的Git地址是：https://github.com/wuanlife/Jianbing_UI.git ，复制下来。
